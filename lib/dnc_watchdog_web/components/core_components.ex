defmodule DncWatchdogWeb.CoreComponents do
  @moduledoc """
  ...
  use Gettext, backend: DncWatchdogWeb.Gettext
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(DncWatchdogWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(DncWatchdogWeb.Gettext, "errors", msg, opts)
    end
  end
