...
#
#     PHX_SERVER=true bin/dnc_watchdog start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :dnc_watchdog, DncWatchdogWeb.Endpoint, server: true
end

if config_env() == :prod do
  database_path =
    System.get_env("DATABASE_PATH") ||
      Path.expand("../priv/repo/dnc_watchdog.db", __DIR__)
  ...
  config :dnc_watchdog, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
  ...
  #
  #     config :dnc_watchdog, DncWatchdog.Mailer,
